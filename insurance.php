...
<section class="mortgage-sec">
    <div class="container">
        <div class="mortgage-heading">
            <h1 class="animate__animated animate__fadeInDown animate__delay-1s">Insurance</h1>
            <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Find the Best Insurance</h3>
        ...
        <div class="animate__animated animate__fadeInLeft animate__delay-1s">
            <div class="mortage-imgbox">
                <img src="img/insurance.png" alt="" class="img-fluid">
            </div>
        </div>
        <div class="heading">
            <a href="auto-insurance-1.php" class="animate__animated  animate__fadeInDown animate__delay-1s">Auto Insurance </a>
            <a href="home-insurance.php" class="animate__animated  animate__fadeInDown animate__delay-1s">Life Insurance</a>
            <a href="home-insurance.php" class="animate__animated  animate__fadeInDown animate__delay-1s">Home Insurance</a>
