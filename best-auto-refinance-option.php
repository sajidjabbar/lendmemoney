...
<section class="homeequityloan-sec">
    <div class="container">
        <div class="Refinance-heading">
            <h1 class="animate__animated animate__fadeInDown animate__delay-1s">Best Auto Refinance Options</h1>
            <div class="aboutrefinance-heading">
                <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Find the Best Auto Refinance Options
                </h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="collapsed card-link" data-toggle="collapse" href="#collapseeight">
                                    <span>Dignissim cras tincidunt lobortis feugiat vivamus. Et ligula ullamcorper
                                        malesuada proin libero nuncs </span> <i class="fa fa-plus"></i>
                                </a>
                            </div>
