            ...
            <div class="all-nav">
                <ul class="all-normal-navs">
                    ...
                    <div class="navbar-items ml-auto">
                        <li class="normal-nav-items"><a href="">Home</a></li>
                        <li class="normal-nav-items dropdown">
                            <a href="#">Mortgage<i class="fa fa-angle-down"></i></a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="#">Home Loans Page</a>
                                <a class="dropdown-item" href="#">Reverse Mortgage Lenders</a>
                            </div>
                        </li>
                        <li class="normal-nav-items dropdown">
                        ...
                        <li class="normal-nav-items dropdown">
                            <a href="">Credit Cards<i class="fa fa-angle-down"></i></a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <li class="normal-nav-items ml-4"><a href="" class="yellowish-color">Become A Member</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#">
                            ...
                            <a class="dropdown-item" class="nav-link" href="#">
                                Credit Cards <i class="fa fa-angle-down"></i>
