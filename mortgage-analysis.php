...
<section class="refinance-mortgage-lenders-sec">
    <div class="container">
        ...
        <div class="Refinance-heading">
            ...
            <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Best & Accurate Mortgage Analysis</h3>
            <p class="animate__animated animate__fadeInDown animate__delay-1s">Sit amet commodo nulla facilisi nullam. Lectus mauris ultrices eros in cursus turpis massa. Velit
                egestas dui id ornare. Orci porta non pulvinar neque laoreet suspendisse interdum consectetur libero.</p>
        </div>
            ...
            <div class="refinance-tabs">
                <div class="tabs">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="step06-tab" data-toggle="tab" href="#step06" role="tab" aria-controls="step06" aria-selected="false">Step06</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="step07-tab" data-toggle="tab" href="#step07" role="tab" aria-controls="step07" aria-selected="false">Step07</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="tab1form">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect1" |>
                                                ...
                                                <option>Dropdown will include</option>
                                        ...
                                        <div class="analysis">
                                            <a href="cheerspage.php"><button>Next</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="step06" role="tabpanel" aria-labelledby="step06-tab">
                <div class="about-tab1">
                                <div class="tab-1">
                                    <div class="tab1form">
                                    <div class="form-group">
                ...
                <div class="tab-pane fade" id="step07" role="tabpanel" aria-labelledby="step07-tab">
