    ...
    <div class="container">
        <div class="Refinance-heading">
            <div class="Refinance-heading6">
                <h1 class="animate__animated animate__fadeInDown animate__delay-1s">Instalment Loans for Bad Credits
                </h1>
                <div class="aboutrefinance-heading">
                    <h3 class="animate__animated animate__fadeInDown animate__delay-1s"> Find the Best Instalment Loans
                        for Bad Credits</h3>
            ...
            <div class="animate__animated animate__fadeInRight animate__delay-1s ">
                ...
                <div class="better-info">
                    <div class="row better">
                        ...
                        <div class="col-md-3">
                            <div class="est-abouts12 text-center">
