...
<section class="mortgage-sec">
    <div class="container">
        <div class="mortgage-heading">
            <h1 class="animate__animated animate__fadeInDown animate__delay-1s">Credit Cards</h1>
            <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Choose the Credit Cards</h3>
        ...
        <div class="animate__animated animate__fadeInLeft animate__delay-1s">
            <div class="mortage-imgbox">
                <img src="img/group-card.png" alt="" class="img-fluid">
            </div>
        </div>
        <div class="heading">
        ...
        <div class="about-mortagage">
            <div class="animate__animated animate__fadeInLeft animate__delay-1s">
                <h5>Top credit cards Of the year</h5>
                <p>Sit amet commodo nulla facilisi nullam. Lectus mauris ultrices eros in cursus turpis massa. Velit
                    egestas dui id ornare. Orci porta non pulvinar neque laoreet suspendisse interdum consectetur
                    libero.</p>
            </div>
        </div>
                    ...
                    <div class="faq-wrapper">
                        <div id="accordion">
                            <div class="card">
                                ...
                                <div id="collapsetwos" class="collapse" data-parent="#accordion" aria-expanded="false">
                                    <div class="card-body">
                                        <p>
                                            Duis aute irure dolor in reprehenderit in voluptate velit esse
                                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                ...
                <div class="col-lg-12">
                    <div class="faq-wrapper">
                        <div id="accordion">
                            <div class="card">
                                <div class="card-header">
                                    <a class="card-link collapsed" data-toggle="collapse" href="#collapsethrees"
                                        aria-expanded="false">
                                        <span class="accord">What Makes discover best it is Best </span>
                                        <img src="img/arrowdown.png" alt="">
                                    </a>
                                </div>
                                <div id="collapsethrees" class="collapse" data-parent="#accordion" aria-expanded="false">
                                    <div class="card-body">
                                        <p>
                                            Duis aute irure dolor in reprehenderit in voluptate velit esse
                                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                    ...
                    <div class="faq-wrapper">
                        <div id="accordion">
                            <div class="card">
                                ...
                                <div id="collapsefours" class="collapse" data-parent="#accordion" aria-expanded="false">
                                    <div class="card-body">
                                        <p>
                                            Duis aute irure dolor in reprehenderit in voluptate velit esse
                                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                ...
                <div class="col-lg-12">
                    <div class="faq-wrapper">
                        <div id="accordion">
                            <div class="card">
                                <div class="card-header">
                                    <a class="card-link collapsed" data-toggle="collapse" href="#collapsefives"
                                        aria-expanded="false">
                                        <span class="accord">What Makes discover best it is Best </span>
                                        <img src="img/arrowdown.png" alt="">
                                    </a>
                                </div>
                                <div id="collapsefives" class="collapse" data-parent="#accordion" aria-expanded="false">
                                    <div class="card-body">
                                        <p>
                                            Duis aute irure dolor in reprehenderit in voluptate velit esse
                                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
            ...
            <div class="col-md-5">
                <div class="animate__animated animate__fadeInDown  animate__delay-1s">
                    <div class="articles-btn">
                        <a href="#"> View More <i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i></a>
                    </div>
                </div>
