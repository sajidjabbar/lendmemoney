        ...
        <div class="row">
            <div class="col-md-5">
                <div class="web-header">
                    <h2>Let us help you to</h2>
                    <h1>Lower your monthly</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-5 vission">
                <div class="vission-heading">
                    <h5>Our Vission</h5>
                    <h3>We help people to improve</h3>
                    <h3>Their lives financially</h3>
                </div>
                <div class="vission-text">
                    ...
                    <p>aliquip ex ea commodo consequat nisi ut.</p>
                </div>
                <div class="vission-text">
                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum </p>
                    <p>dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non provident.</p>
                </div>
                <a href="#"> <button>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="money-heading">
                        <h2>Get the most out of Your Money</h2>
                ...
                <div class="col-md-4 p-0 m-0">
                    <div class="money-imgbox">
                        <img src="img/money.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="about-info">
                    <div class="info-heading">
                        ...
                        <h3>About lend me money</h3>
                    </div>
                    <div class="about-info">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed <br> do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam.</p>
                    </div>
                    <div class="info-heading">
                        <h5>Consectetuer Adipiscing</h5>
                    </div>
                    <div class="about-info">
                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse <br> cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non provident.</p>
                    </div>
                    <div class="info-heading">
            ...
            <div class="col-md-6">
                <div class="info-imgbox">
                    <img src="img/info.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="line">
                <div class="col-md-10 p-0 m-0">
                    <div class="article-heading">
                        <h5>Our Articles</h5>
                        <h3>Read our best Article to know more</h3>
                    </div>
                </div>
                <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="frequently-heading">
                    ...
                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmd tempor incididunt ut labore et dolore magna aliqua. </h5>
                </div>
                <div id="accordion">
                    <div class="card">
