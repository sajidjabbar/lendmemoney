...
<link rel="stylesheet" href="css/mortgage-toolspage.css">
<?php include 'inc/app.php'; ?>
<!-- start here -->
<section class="mortgage-sec">
    <div class="container">
        <div class="mortgagetoolspage-heading">
            <h1 class="animate__animated animate__fadeInDown animate__delay-1s">Mortgage Tools page</h1>
            <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Find the Right Mortgage For Yourself</h3>
        ...
        <div class="animate__animated animate__fadeInLeft animate__delay-1s">
            <div class="mortagetoolspage-imgbox">
                <img src="img/tools-page.png" alt="" class="img-fluid">
            </div>
        </div>
        ...
        <div class="about-mortagagetoolspage">
            <div class="animate__animated animate__fadeInLeft animate__delay-1s">
                <h2>How mortgage tool page refinance calculator Helps?</h2>
            </div>
