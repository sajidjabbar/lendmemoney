...
<section class="compare-mortgage-sec">
    <div class="container">
        ...
        <div class="campare-heading2">
            ...
            <p class="animate__animated animate__fadeInDown animate__delay-1s">Enter your ZIP code to get today’s mortgage rates for you.</p>
                ...
                <div class="zip-btn ">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Zip">
