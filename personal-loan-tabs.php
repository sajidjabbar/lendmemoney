...
<link rel="stylesheet" href="css/personal-loan-tabs.css">
...
<section class="refinance-mortgage-lenders-sec">
    <div class="container">
        ...
        <div class="Refinance-heading">
            ...
            <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Find the best Personal Loan
            </h3>
                            ...
                            <div class="tab-1">
                                <div class="tab1form">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" id="exampleFormControlSelect1"
                        ...
                        <div class="col-lg-5">
                            <div class="tab-1">
                                <div class="tab1form">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Your Employment Status</label>
                                        <select class="form-control" id="exampleFormControlSelect1" |>
