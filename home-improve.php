    ...
    <div class="container">
        <div class="Refinance-heading">
            ...
            <div class="aboutrefinance-heading">
                <h3 class="animate__animated animate__fadeInDown animate__delay-1s">Find the Best Home Improvement Loans</h3>
                <p class="animate__animated animate__fadeInDown animate__delay-1s">Lorem ipsum dolor sit amet,
                    consectetur adipiscing
                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                <div class="home-btn">
                    <a href="home-improvement-loan.php">Get Started</a>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <a class="card-link collapsed" data-toggle="collapse"
                                                        href="#collapseones" aria-expanded="false">
                                ...
                                <div class="col-md-12 p-0 m-0">
                                    <div class="faq-wrapper">
                                        <div id="accordion">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a class="card-link collapsed" data-toggle="collapsetwo"
                                    ...
                                    <div class="faq-wrapper">
                                        <div id="accordion">
                                            <div class="card">
                                                ...
                                                <div id="collapsethrees" class="collapse" data-parent="#accordion"
                                                    aria-expanded="false">
                                                    <div class="card-body">
                                                        <p>
                                                            Duis aute irure dolor in reprehenderit in voluptate velit
                                    ...
                                    <div class="faq-wrapper">
                                        <div id="accordion">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a class="card-link collapsed" data-toggle="collapse"
                                                        href="#collapsefours" aria-expanded="false">
                                                        <span class="accord">View all details </span>
                                                        <img src="img/arrowdown.png" alt="">
                                                    </a>
                                                </div>
