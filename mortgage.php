...
<section class="mortgage-sec">
    <div class="container">
        <div class="mortgage-heading">
            <h1 class="animate__animated animate__fadeInDown animate__delay-1s">Mortgage</h1>
            <h3 class="animate__animated animate__fadeInDown animate__delay-1s">We help people to improve</h3>
        ...
        <div class="animate__animated animate__fadeInLeft animate__delay-1s">
            <div class="mortage-imgbox">
                <img src="img/mortgage.png" alt="" class="img-fluid">
            </div>
        </div>
        <div class="heading">
        ...
        <div class="about-mortagage">
            <div class="animate__animated animate__fadeInLeft animate__delay-1s">
                <h5>Tips for Mortgage</h5>
                <h2>Learn strategies for saving a down payment, applying<br>
                    for a mortgage</h2>
            </div>
